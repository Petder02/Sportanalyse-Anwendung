...
import { makePlayerData, makeTeamData } from "./makeBasketballData"
...
import fs from "fs";
const BasketballMainTable = ({onDataSelect}) => {
            ...
            },
            {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        header: () => <span>Points Per Game</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "assistsPerGame",
                        header: () => <span>Assists Per Game</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "stealsPerGame",
                        header: () => <span>Steals Per Game</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "blocksPerGame",
                        header: () => <span>Blocks Per Game</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "turnoversPerGame",
                        header: () => <span>Turnovers Per Game</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "playerEfficiencyRating",
                        header: () => <span>Player Efficiency Rating</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "winShares",
                        header: () => <span>Win Shares</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "fieldGoalPercentage",
                        header: () => <span>Field Goal %</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "threePointPercentage",
                        header: () => <span>Three Point %</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "freeThrowPercentage",
                        header: () => <span>Free Throw %</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "effectiveFieldGoalPercentage",
                        header: () => <span>Effective Field Goal %</span>,
                        footer: props => props.column.id
                    },
                    {
                        accessorKey: "trueShootingPercentage",
                        header: () => <span>True Shooting %</span>,
                        footer: props => props.column.id
                    }
                ]
            },
...
export default BasketballMainTable;